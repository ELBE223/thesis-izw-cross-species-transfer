...
metric_paths <- tribble(
  ...
  "ResNet",         "within", file.path(base_dir, "ResNet",        "Within_ResNet",         "statistics", "within_summary_metrics.csv"),
  "ResNet",         "cross",  file.path(base_dir, "ResNet",        "Cross_ResNet",          "statistics", "cross_summary_metrics.csv"),
