...
# =============================================================================
# H3_sensitivity_revised
# Sensitivity analyses for H3 
#
# Four checks:
#   1. Leave-one-trait-out   (LOTO)
#   2. Leave-one-species-out (LOSO)
#   3. Bootstrap CIs         (95% CI for Spearman rho)
#   4. Pseudoreplication     (row vs dataset-pair vs species-pair)
# =============================================================================
...
model_files <- tribble(
  ...
  "ResNet",        file.path(base_dir, "ResNet",        "Pairwise_ResNet",        "statistics", "pairwise_summary_metrics.csv"), file.path(base_dir, "ResNet",        "Within_ResNet",        "statistics", "within_summary_metrics.csv"),
