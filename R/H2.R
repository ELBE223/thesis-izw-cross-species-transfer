...
# behaviour files (CNN, ResNet, HYDRA, MultiRocket).
...
behavior_paths <- tribble(
  ...
  resolve_existing_file(
    file.path(base_dir, "RF", "Within_RF", "statistics", "behavior_metrics_all.csv"),
    file.path(base_dir, "RF", "Within_RF", "statistics", "within_behavior_metrics_all.csv")
  ),
  file.path(base_dir, "RF", "Within_RF", "statistics"),
  
  "RF", "cross",
  resolve_existing_file(
    file.path(base_dir, "RF", "Cross_RF", "statistics", "behavior_metrics_all.csv"),
    file.path(base_dir, "RF", "Cross_RF", "statistics", "cross_behavior_metrics_all.csv")
  ),
  file.path(base_dir, "RF", "Cross_RF", "statistics"),
  
  # --- LGBM (aggregated file available) ---
  "LGBM", "within",
  resolve_existing_file(
    file.path(base_dir, "LGBM", "Within_LGBM", "statistics", "behavior_metrics_all.csv"),
    file.path(base_dir, "LGBM", "Within_LGBM", "statistics", "within_behavior_metrics_all.csv")
  ),
  file.path(base_dir, "LGBM", "Within_LGBM", "statistics"),
  
  "LGBM", "cross",
  resolve_existing_file(
    file.path(base_dir, "LGBM", "Cross_LGBM", "statistics", "behavior_metrics_all.csv"),
    file.path(base_dir, "LGBM", "Cross_LGBM", "statistics", "cross_behavior_metrics_all.csv")
  ),
  file.path(base_dir, "LGBM", "Cross_LGBM", "statistics"),
