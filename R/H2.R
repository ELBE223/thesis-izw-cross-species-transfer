...
behavior_paths <- tribble(
  ...
  "InceptionTime", "within",    NA_character_,                                                                       file.path(base_dir, "InceptionTime", "Within_InceptionTime",  "statistics"),
  "InceptionTime", "cross",     NA_character_,                                                                       file.path(base_dir, "InceptionTime", "Cross_InceptionTime",   "statistics"),
